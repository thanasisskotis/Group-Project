...
(και 1-1 με την ίδια οντότητα ???,έχουμε δύο συσχετίσεις)
...
- 1:1 (???, 1:ν ίσως??, αν  υποστηρίζουν πολλοί τοπικοί επαγγελματίες) με Local Professional (τοπικό επαγγελματία)
...
- N:M με Property που αποδίδεται ως:
    ...
    και 1:N από Bookings σε Property_has_bookings (???)
...
- 1:n με Reviews 
- M:N με Bookings μέσω της Property_has_bookings  (δεν είναι 1:N??)
...
- (άλλη μια με Property, N:1?, πολλά αιτήματα για κάθε μια ιδιοκτησία)
...
Χαρακτηριστικά:
ΠΡΟΒΛΗΜΑ ΣΤΟ ΠΡΩΤΕΥΟΝ ΚΛΕΙΔΙ!!!, άμα σχολιάσει άλλη ιδιοκτησία χάνεται η  μοναδικότητα
...
- 1:n με host verification (θα έπρεπε να είναι N:M??)
...
- review_description (έχουν τα Wishlists βαθμολογίες???)
...
- N:M με Booking μέσω της Guest has Bookings (θα μπορούσε να γίνει 1:Ν??)
...
- Ν:Μ με Bookings ,μέσω του Host_has_Bookings (δεν είναι 1:Ν???)
...
πολλοί οικοδεσπότες μπορούν να έχουν πολλούς εκπροσώπους (1:N δεν πρέπει με τον Host??)
...
- 1:1 με User, κάθε χρήστης έχει damage report, αν προκαλέσει ζημιά (ίσως 1:n??)
- 1:1 με Property, (ίσως 1:ν??)
...
- n:m με User, πολλοί χρήστες ως επιθεωρητές μπορούν να κάνουν πολλές επιθεωρήσεις (μήπως είναι 1:n?, κάθε επιθεωρητής να κάνει διαφορεικές επιθ
εωρήσεις?)
...
24) Host_has_Bookings 

Βοηθητικό table για Ν:Μ συσχέτιση μεταξύ Host και Booking (δεν είναι Ν:1??, για κάθε ΕΝΑΝ host πολλές κρατήσεις)

Χαρακτηριστικά:

- Host_User_id(πρωτεύον κλειδί), user id του οικοδεσπότη
- Bookings_time_booked (πρωτεύον κλειδί), ημερομηνία κράτησης
- Bookings_Property_property_id (πρωτεύον κλειδί), id ιδιοκτησίας

Συσχετίσεις:

- n:1 με Host , πολλά στοιχεία για κάθε Host
- n:1 με Bookings, πολλά στοιχεία για κάθε κράτηση
...
- Συσχετίσεις με την οντότητα User
