...
πολλοί οικοδεσπότες μπορούν να έχουν πολλούς εκπροσώπους (1:N δεν πρέπει να είναι??)
...
- 1:1 με Property (δεν πρέπει να είναι 1:Ν, κάθε ιδιοκτησία μπορεί να έχει πολλά damage reports)
...
- n:1 με User, πολλές προσκλήσεις από έναν χρήστη προς άλλους
- 1-1 με User(??, δηλαδή 1-1 με αυτόν που κάνει την Πρόσκληση? )
με Property, Host χρειάζεται να προσθέσουμε συσχετίσεις ή όχι?
