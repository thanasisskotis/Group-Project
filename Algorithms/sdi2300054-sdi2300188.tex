...
\begin{algorithmic}[1]
\State \textbf{\begin{otherlanguage}{greek}Είσοδος:\end{otherlanguage}} \begin{otherlanguage}{greek}Γράφημα $G$ (ως \end{otherlanguage} adjacency matrix \begin{otherlanguage}{greek}) με $n$ κορυφές και συνάρτηση \texttt{γνωρίζει$(u, v)$} που επιστρέφει \texttt{True} αν υπάρχει ακμή από $u$ προς $v$.\end{otherlanguage}
